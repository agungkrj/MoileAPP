    ...
    fun ProsesTukarScreen() {
        ...
        Box(
            ...
            IconButton(
                onClick = {
                    val intent = Intent(context, OrderActivity::class.java) // Mengarah ke OrderActivity
                    context.startActivity(intent) // Memulai aktivitas Order
                    (context as? ComponentActivity)?.finish() // Menutup aktivitas saat ini
                },
                modifier = Modifier
